...
void ManPageDisplay(char Name[])
{
    ...
    else if(strcmp(Name,"creat") == 0)
    {
        ...
        printf("FileName: name of file we ant to create");

        printf("Permission: Permission of file we ant to create");
    ...
    else if(strcmp(Name,"unlink") == 0)
    {
        ...
        printf("FileName: name of file we want to delete\n");
    }
    else if(strcmp(Name,"stat") == 0)
    {
        ...
        printf("FileName: name of file whose information should be fetched\n");
    }
    else
    {
...
int stat_file(char name[])
{
    ...
    while(temp != NULL)
    {
        if(strcmp(temp -> FileName, name) == 0)
        {
            ...
            if(Permission == READ)
            {
                printf("File Permissiion: Read Only\n");
            }
            else if(Permission == WRITE)
            {
                printf("File Permissiion: Write\n");
            }
            else if(Permission == READ + WRITE)
            {
                printf("File Permissiion: Read + Write\n");
            }
...
//  Description :       It is used to delete a specific file 
//  Input :             File Name
//  Output :            Exit Status of function
//  Author :            Rucha Walvekar
//  Date :              2/08/2026
              ...
              )
{
    ...
    // check if sufficiaent space is there or not in the Buffer
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            {
                printf("Enter the data hyou want to write in the file\n");

                fgets(InputBufer,MAXFILESIZE,stdin);

                size = strlen(InputBufer);

                iRet = write_file(atoi(Command[1]), InputBufer, size-1);

                if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error: Invalid Parameters");
                    printf("Please refer to man page for more information");                   
                }
                ...
                {
                    printf("Error: No Permission to write the data");
                }
                else if(iRet == ERR_INSUFFICIENT_SPACE)
                {
                    printf("Error: No Space to write the data");
                }
                else
                {
        ...
        else if(iCount == 3)
        {
            ...
            else if(strcmp(Command[0], "read") == 0)
            {
                ...
                {
                    printf("Error : File has insuficient data\n");
                }
                else if(iRet == ERR_PERMISSION_DENIED)
                {
